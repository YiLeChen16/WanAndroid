 ...
 * @version 1.0
 */
class HarmonyContentListAdapter @Inject constructor(@ActivityContext val context: Context) :
    BaseRecyclerViewAdapter<ArticleItemData, ItemHarmonyViewBinding>(R.layout.item_harmony_view){
