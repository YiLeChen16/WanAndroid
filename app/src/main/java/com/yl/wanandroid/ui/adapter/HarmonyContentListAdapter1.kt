 ...
 * @version 1.0
 */
class HarmonyContentListAdapter1 @Inject constructor(@ActivityContext val context: Context) :RecyclerView.Adapter<HarmonyContentListAdapter1.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            //点击跳转到WebActivity
            WebViewActivity.start(context,data[position].link)
        }
    }
