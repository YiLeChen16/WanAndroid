...
import com.yl.wanandroid.ui.adapter.home.HarmonyContentListAdapter
...
class HarmonyFragment : BaseVMFragment<FragmentHarmonyBinding, HarmonyFragmentViewModel>(
    ...
    override fun observeLiveData() {
        ...
        //初始化数据
        mViewModel.harmonyColumnDataBean.observe(viewLifecycleOwner) { harmonyColumnData ->
            LogUtils.d(this, "harmonyColumnData-->$harmonyColumnData")
            if (harmonyColumnData == null) return@observe
